...
| Priorytet | Tytuł                                       | Slug                                  | Opis                                       |
| --------- | ------------------------------------------- | ------------------------------------- | ------------------------------------------ |
| 🔴        | Jak napisać wstęp do pracy magisterskiej    | `/poradniki/wstep/`                   | Struktura, elementy obowiązkowe, przykłady |
| 🔴        | Jak napisać zakończenie pracy magisterskiej | `/poradniki/zakonczenie/`             | Wnioski, podsumowanie, rekomendacje        |
| 🔴        | Spis treści pracy magisterskiej             | `/poradniki/spis-tresci/`             | Formatowanie, numeracja, automatyzacja     |
| 🔴        | Streszczenie pracy magisterskiej            | `/poradniki/streszczenie/`            | Po polsku i angielsku, słowa kluczowe      |
| 🟡        | Struktura pracy magisterskiej               | `/poradniki/struktura/`               | Rozdziały, podrozdziały, proporcje         |
| 🟡        | Rozdział teoretyczny                        | `/poradniki/rozdzial-teoretyczny/`    | Przegląd literatury, definicje, teorie     |
| 🟡        | Rozdział metodologiczny                     | `/poradniki/rozdzial-metodologiczny/` | Opis metodologii w pracy                   |
| 🟡        | Rozdział badawczy                           | `/poradniki/rozdzial-badawczy/`       | Prezentacja wyników, analiza               |
...
| 🔴        | Badania ilościowe                        | `/poradniki/metodologia/badania-ilosciowe/`  | Ankiety, statystyka, analiza       |
| 🔴        | Badania jakościowe                       | `/poradniki/metodologia/badania-jakosciowe/` | Wywiady, obserwacja, case study    |
| 🔴        | Jak przeprowadzić ankietę                | `/poradniki/metodologia/ankieta/`            | Projektowanie, zbieranie, analiza  |
| 🔴        | Jak przeprowadzić wywiad                 | `/poradniki/metodologia/wywiad/`             | Rodzaje, transkrypcja, analiza     |
| 🔴        | Hipotezy badawcze                        | `/poradniki/metodologia/hipotezy/`           | Formułowanie, weryfikacja          |
| 🔴        | Dobór próby badawczej                    | `/poradniki/metodologia/dobor-proby/`        | Metody doboru, wielkość próby      |
| 🟡        | Pytania badawcze                         | `/poradniki/metodologia/pytania-badawcze/`   | Formułowanie, rodzaje pytań        |
| 🟡        | Problemy badawcze                        | `/poradniki/metodologia/problemy-badawcze/`  | Identyfikacja, formułowanie        |
| 🟡        | Zmienne badawcze                         | `/poradniki/metodologia/zmienne/`            | Zależne, niezależne, pośredniczące |
...
| 🟡        | Metody i techniki badawcze               | `/poradniki/metodologia/metody/`             | Przegląd metod badawczych          |
...
| Priorytet | Tytuł                             | Slug                               | Opis                                               |
| --------- | --------------------------------- | ---------------------------------- | -------------------------------------------------- |
| 🔴        | Bibliografia - kompletny poradnik | `/poradniki/bibliografia/`         | Style, formatowanie, narzędzia                     |
| 🔴        | Cytowanie w pracy magisterskiej   | `/poradniki/cytowanie/`            | Bezpośrednie, pośrednie, parafrazowanie            |
...
| Priorytet | Tytuł                      | Slug                         | Opis                                 |
| --------- | -------------------------- | ---------------------------- | ------------------------------------ |
| 🔴        | Obrona pracy magisterskiej | `/poradniki/obrona/`         | Przygotowanie, pytania, stres        |
